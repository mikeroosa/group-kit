defmodule GroupKitWeb.MemberControllerTest do
  use GroupKitWeb.ConnCase

  alias GroupKit.Core

  @create_attrs %{email_address: "some email_address", first_name: "some first_name", is_subscribed: true, last_name: "some last_name"}
  ...
  def fixture(:member) do
    {:ok, member} = Core.create_member(@create_attrs)
    member
  end
